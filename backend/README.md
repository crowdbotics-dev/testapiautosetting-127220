...
## Project Structure
    ...
    ├── testapiautosetting_127220  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127220`
...
2. Clone this repo and `cd testapiautosetting_127220`
